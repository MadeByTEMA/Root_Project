...
public class Board implements Serializable {
  ...
  public String toString() {
    return "Board [no=" + no + ", title=" + title + ", date=" + date + ", viewCount=" + viewCount + ", writer=" + writer
        + "]";
  }
  ...
  public String toCsvString() {
    return String.format("%d,%s,%s,%d,%s", this.getNo(), this.getTitle(), this.getDate(), this.getViewCount(),
        this.getWriter());
  }

...
public class Lesson implements Serializable {
  ...
  public String toString() {
    return "Lesson [no=" + no + ", title=" + title + ", description=" + description + ", startDate=" + startDate
        + ", endDate=" + endDate + ", totalHours=" + totalHours + ", dayHours=" + dayHours + "]";
  }
  ...
  public String toCsvString() {
    return String.format("%d,%s,%s,%s,%s,%d,%d", this.getNo(), this.getTitle(), this.getDescription(),
        this.getStartDate(), this.getEndDate(), this.getTotalHours(), this.getDayHours());
  }
